...
ayuda_pegado = (
    ...
    "4. Pegue la tabla completa de SIPF ("Evolucion de ventas totales, locales y al exterior >> Enero 2022 a Diciembre 2026 >> Importe AR$ >> Visualizar reporte >> Pegar tabla con titulos hasta el promedio vertical"):"
)
