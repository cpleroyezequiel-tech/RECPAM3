...
3. Ingrese el **Periodo de Cierre** (formato AAAAMM, ej: 202606).
...
indices_base = {
    ...
    "2026/05": 11607.3937, "2026/06": 11826.4103}
...
if data_pegada:
    if len(raw_input) < 6:
        st.warning("Por favor, complete el periodo con 6 dígitos (ejemplo: 202605).")
